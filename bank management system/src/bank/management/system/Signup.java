...
public class Signup extends JFrame implements ActionListener {
    ...
    // Constructor to initialize components and layout
    Signup() {
        ...
        // Labels for form sections and fields
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            new Signup2(first).setVisible(true); // Move to the next part of the signup process
            setVisible(false);
